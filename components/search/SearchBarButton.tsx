...
export const SearchBarButton = ({ onClick = null, kbd = ACTION_KEY_DEFAULT }) => {
  return (
    <button
      onClick={onClick}
      title="Search"
      className="mx-4 flex h-[34px] w-[34px] cursor-text items-center justify-center rounded-md border border-gray-800 bg-gray-50 px-2 text-sm hover:border-blue-600 hover:bg-gray-100 dark:border-gray-200 dark:bg-gray-900 dark:hover:border-blue-600 dark:hover:bg-gray-800 [@media(min-width:810px)]:w-[unset]"
    >
      <span className="my-2 block  w-4 [@media(min-width:810px)]:mr-2">
        <svg
      ...
      <span className="mr-8 hidden text-slate-600 dark:text-slate-300 min-[900px]:block">
        Search...
      </span>
      <kbd
