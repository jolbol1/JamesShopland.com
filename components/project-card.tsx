...
const ProjectCard = ({
  ...
  <div className={className ?? 'md relative grow p-4 md:w-1/2 md:grow-0 2xl:w-1/3'}>
        ...
        <div className="h-full overflow-hidden rounded-lg ">
          <div className="flex h-full flex-col justify-between ">
            <div>
              ...
              <p className=" max-w-none mb-3 text-gray-700 dark:text-gray-400">{description}</p>
            </div>
            <div className="flex">
              {links &&
                links.map((link, index) => (
                  <div key={`${title}-${link.title}-links`}>
                    ...
                    <Link
                      ...
                      href={link.href}
                      className="text-base font-medium leading-6 text-primary hover:text-primary-hover"
