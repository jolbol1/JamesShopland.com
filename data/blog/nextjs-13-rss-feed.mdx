...
date: '2023-04-21'
tags: ['nextjs', 'rss', 'feed', 'app directory', 'web-development', 'contentlayer']
draft: false
...
<Callout>
  You can call this directory whatever you want, it will be the URL for the rss feed. In this case
  `/feed.xml`
</Callout>
...
<Callout>
  As stated in the introduction, for getting all my blog posts, I will be using content layer and
  some helper functions. This guide assumes you have already set up a blog site, so should be
  familiar with how you fetch content.
</Callout>
