...
<Callout>
**Don't I need React?**<br/>
No. While the package sounds like it was made for React projects only, its more complex than that. React wasn't just built for the web and Theo has a great explainer of this [here](https://www.youtube.com/watch?v=Y12sGu8-qFE). 
Essentially, React is the underlying technology to make things composable and React-Dom is the layer that renders to HTML, React Email is the renderer to email HTML, which can be annoyingly difficult.
</Callout>
