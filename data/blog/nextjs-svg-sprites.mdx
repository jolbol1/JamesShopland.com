...
https://youtu.be/_Xrz7FeOtC0

<Callout>
**Credit**<br/>
The code I will be using is slightly modified from Kent C. Dodds Epic Stack [implementation](https://github.com/epicweb-dev/epic-stack/blob/main/docs/decisions/020-icons.md). His is for Remix.js. I have modified a few parts to make it work on NextJs.
</Callout>
